...
Edit mode updates cells, rows, and columns, then saves. Tab and Enter move between cells without breaking IME composition. Undo reverses the last edit; Redo brings it back. Drag or Shift-click to copy, cut, or clear a cell range. Drag a column header edge to set the width.
